...
public class Bullet1 : MonoBehaviour, IPlayerBullet
{
	...
	[SerializeField] float timerForNextAttack = 0.1f; //возможно стоит сделать базовый класс для пули и запихнуть в него эти параметры, если кулдаун останется одним и тем же
	[SerializeField] float cooldown = 0.1f;

	private int bulletOwnDamage = 10;
